...
def DownloadChannel(channel_link, folder):
    ...
    for video in list_videos:
        if video in list_videos_downloaded:
            ...
            DownloadVideo(video_link=video, folder=folder)
...
DownloadChannel(channel_link="https://www.youtube.com/c/TheDailyGwei/videos",
                folder="TheDailyGwei")